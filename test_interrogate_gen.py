...
def test_interrogate_gen():
    gen_path = Path("/home/gregm/hardware_exercises/picker/assets/img2img_output.png")
    ...
    print(f"Sending request to {url} for GENERATED image...")
